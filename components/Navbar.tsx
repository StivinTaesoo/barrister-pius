...
export const Navbar = () => {
    ...
    return (
        <>
            ...
            {/* Mobile Navbar */}
            <div className="w-full flex items-center justify-end bg-grey backdrop-blur-sm py-4 bg-opacity-10 fixed -top-2 z-20 md:hidden">
                <RiMenu4Fill onClick={handleClick} className="mr-4" />
                <ul
                    className={
                        click
